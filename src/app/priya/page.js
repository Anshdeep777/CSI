...
const StatusBadge = ({ color, label, live = true }) => (
  <span
    className="flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] tracking-[0.2em] uppercase font-semibold"
...
const DialogueBox = React.forwardRef(
  ({ color, name, badge, children, className = "", pointer = "none" }, ref) => {
    ...
    const pointerStyles = {
      right: {
        ...
        borderColor: `transparent ${c.border} ${c.border} transparent`,
      },
      left: {
        left: "-10px",
        top: "50%",
    ...
    return (
      ...
      >
        ...
        {pointer !== "none" && (
          <span
            className="hidden md:block absolute w-[18px] h-[18px]"
            style={{
              background: "rgba(2,4,8,0.85)",
              border: `1px solid ${c.border}`,
              ...pointerStyles[pointer],
            }}
          />
        )}
        <div
...
const DossierButton = ({ icon: Icon, label, color, accent, href }) => {
  ...
  return (
    ...
    >
      ...
      <ChevronRight
        size={12}
        className="ml-auto relative z-10 opacity-40 group-hover:opacity-100 transition-opacity"
      />
    </Tag>
  );
};
...
const CharacterPanel = ({
  ...
  <div
    className={`w-full max-w-lg flex flex-col items-center ${align === "end" ? "md:items-end" : "md:items-start"}`}
  >
    <div className="relative group shrink-0 md:-translate-y-10">
      <div
        ref={glowRef}
        className="absolute inset-0 rounded-full blur-3xl scale-125 opacity-50 pointer-events-none"
        style={{ background: tokens[color].pulse }}
      />
      <img
        ref={imgRef}
        src={src}
        alt={alt}
        className="w-40 md:w-72 lg:w-80 h-auto relative z-10 object-contain"
        style={{
          filter: `drop-shadow(0 0 40px ${tokens[color].glow})`,
          maxHeight: "420px",
        }}
      />
    </div>
  ...
  <div className="w-full py-20 flex flex-col items-center justify-center relative z-10">
    ...
    <div className="flex items-center gap-6 md:gap-12 w-full max-w-5xl px-8 relative z-10">
      ...
      <div className="flex flex-col items-center text-center gap-2">
        ...
        <h2
          className="text-3xl md:text-5xl font-black tracking-[0.12em] uppercase"
...
const Cursor = ({ color }) => (
  <span
    className="inline-block w-[3px] h-[1.1em] ml-0.5 animate-pulse align-middle rounded-[1px]"
...
const Page = () => {
  ...
  const fullText =
    "Listen up. The executive board is panicking, but you were brought here for a reason. Trust your instincts, give it your absolute best, and don't let the chaos overwhelm you. Are you ready to deploy?";
  const priyaText =
    "Welcome to the team. Sprint is bleeding money, and GreenBridge Capital just blocked our ₹800 Cr Series B. I need your consulting pod to figure out what we are actually dealing with. Let's talk.";
  const managerText =
    "Sprint is in absolute chaos. First, review the briefing on the core mechanics of consulting. Second, read the baseline on corporate sustainability. Consider this your initiation test: Based on those three pillars, submit a one-paragraph diagnostic of Sprint's 10-minute delivery model immediately to my secure drop folder.";
  const ceoText =
    "I don't understand why we are wasting precious operational time on this. Sprint is a hyper-growth tech company. Why does a rapid delivery app need to care about global sustainability limits when we are fighting for market share?";
  const manager2Text1 =
    "The CEO is aggressively pushing back. He views this as a PR exercise, not operational reality. You need to prove to him that this is a strict business survival issue. Access the research on why sustainability matters in modern business. Use this data to show him that ignoring this balance leads to critical social and environmental instability that directly threatens human life and long-term economic growth. Furthermore, it is essential for managing immediate risks, complying with increasing regulations, and attracting stable investment capital.";
  const manager2Text2 =
    "Then, read the brief on innovation. Frame your entire argument around the concept that sustainability identifies the specific needs and urgent requirements, while innovation creates the technical solutions to address those needs. We are here to innovate, not stall his company.";
  const manager3Text1 =
    "Sprint's massive waste problem didn't just appear out of nowhere. It is being violently driven by macro-economic forces. I need you to understand the overarching global context before we zoom in to audit their local dark-store operations.";
  const manager3Text2 =
    "Read the industry overview on global sustainability challenges. You need to understand how four primary forces are driving this systemic failure: Growing Population, Economic Growth, Rising Consumption, and Limited Resources. Pay special, focused attention to how a 'buy-and-throw-away' culture dangerously accelerates resource depletion and generates massive amounts of waste.";
  const priya2Text =
    "Our riders are getting into severe accidents because of the 10-minute timer. If we increase the timer to protect them, customers leave for Instantly. How do we fix this without completely breaking the company's unit economics?";

  const manager4Text1 =
    "She is looking at isolated symptoms and panicking, missing the entire system. Open your terminal and read the module on Systems Thinking. You must learn to distinguish the deep, underlying drivers—the root causes—from the visible, surface-level effects, which are just symptoms.";
  const manager4Text2 =
  ...
  const manager5Text =
    "The time for theory is over. The executive board is waiting for our preliminary diagnostic, and GreenBridge Capital is monitoring our outputs. You must use the Systems Thinking and Trade-off frameworks to map Sprint's top three interconnected sustainability failures. Do not sugarcoat the reality. Expose the feedback loops destroying their rider safety and the root causes driving their packaging waste. Draft your analysis, ensure all claims are backed by the week's intel, and upload the 2-page diagnostic memo directly into the central hub before the weekend deadline.";

  const priyaBoxRef = useRef(null);
  const priyaTextRef = useRef(null);
  const priyaImgRef = useRef(null);
  const priyaGlowRef = useRef(null);
  const managerBoxRef = useRef(null);
  const managerTextRef = useRef(null);
  const managerImgRef = useRef(null);
  const managerGlowRef = useRef(null);
  const ceoBoxRef = useRef(null);
  const ceoTextRef = useRef(null);
  const ceoImgRef = useRef(null);
  const ceoGlowRef = useRef(null);
  const manager2ContainerRef = useRef(null);
  const manager2BoxRef1 = useRef(null);
  const manager2TextRef1 = useRef(null);
  const manager2BoxRef2 = useRef(null);
  const manager2TextRef2 = useRef(null);
  const manager2ImgRef = useRef(null);
  const manager2GlowRef = useRef(null);
  const manager3ContainerRef = useRef(null);
  const manager3BoxRef1 = useRef(null);
  const manager3TextRef1 = useRef(null);
  const manager3BoxRef2 = useRef(null);
  const manager3TextRef2 = useRef(null);
  const manager3ImgRef = useRef(null);
  const manager3GlowRef = useRef(null);
  const priya2BoxRef = useRef(null);
  const priya2TextRef = useRef(null);
  const priya2ImgRef = useRef(null);
  const priya2GlowRef = useRef(null);

  const manager4ContainerRef = useRef(null);
  const manager4BoxRef1 = useRef(null);
  const manager4TextRef1 = useRef(null);
  const manager4BoxRef2 = useRef(null);
  const manager4TextRef2 = useRef(null);
  const manager4ImgRef = useRef(null);
  const manager4GlowRef = useRef(null);

  const manager5ContainerRef = useRef(null);
  const manager5BoxRef = useRef(null);
  const manager5TextRef = useRef(null);
  const manager5ImgRef = useRef(null);
  const manager5GlowRef = useRef(null);
  ...
  useGSAP(() => {
    ...
    const buildScene = ({
      ...
      tl.from(box, { y: 60, opacity: 0, duration: 0.9, ease: "expo.out" }).to(
        textEl,
        { text, duration: text.length * speed, ease: "none" },
        "+=0.15",
      );
      gsap.to(imgEl, {
        y: -14,
    ...
    buildScene({
      trigger: priyaBoxRef.current,
      box: priyaBoxRef.current,
      textEl: priyaTextRef.current,
      text: priyaText,
      imgEl: priyaImgRef.current,
      glowEl: priyaGlowRef.current,
    });
    buildScene({
      trigger: managerBoxRef.current,
      box: managerBoxRef.current,
      textEl: managerTextRef.current,
      text: managerText,
      speed: 0.025,
      imgEl: managerImgRef.current,
      glowEl: managerGlowRef.current,
    });
    buildScene({
      trigger: ceoBoxRef.current,
      box: ceoBoxRef.current,
      textEl: ceoTextRef.current,
      text: ceoText,
      imgEl: ceoImgRef.current,
      glowEl: ceoGlowRef.current,
    });
    buildScene({
      trigger: priya2BoxRef.current,
      box: priya2BoxRef.current,
      textEl: priya2TextRef.current,
      text: priya2Text,
      imgEl: priya2ImgRef.current,
      glowEl: priya2GlowRef.current,
    });

    const m2Tl = gsap.timeline({
      scrollTrigger: {
        trigger: manager2ContainerRef.current,
        start: "top 78%",
        once: true,
      },
    });
    m2Tl
      .from([manager2BoxRef1.current, manager2BoxRef2.current], {
        y: 60,
        opacity: 0,
        duration: 0.9,
        ease: "expo.out",
      ...
      .to(
        manager2TextRef1.current,
        {
          text: manager2Text1,
          duration: manager2Text1.length * 0.018,
          ease: "none",
        },
        "+=0.1",
      )
      .to(
        manager2TextRef2.current,
        {
          text: manager2Text2,
          duration: manager2Text2.length * 0.025,
          ease: "none",
        },
        "+=0.15",
      );
    gsap.to(manager2ImgRef.current, {
      y: -14,
      duration: 2.8,
      yoyo: true,
      repeat: -1,
    ...
    gsap.to(manager2GlowRef.current, {
      scale: 1.15,
      opacity: 0.7,
      duration: 2.4,
      yoyo: true,
    ...
    const m3Tl = gsap.timeline({
      scrollTrigger: {
        trigger: manager3ContainerRef.current,
        start: "top 78%",
        once: true,
      },
    });
    m3Tl
      .from([manager3BoxRef1.current, manager3BoxRef2.current], {
        y: 60,
        opacity: 0,
        duration: 0.9,
        ease: "expo.out",
      ...
      .to(
        manager3TextRef1.current,
        {
          text: manager3Text1,
          duration: manager3Text1.length * 0.028,
          ease: "none",
        },
        "+=0.1",
      )
      .to(
        manager3TextRef2.current,
        {
          text: manager3Text2,
          duration: manager3Text2.length * 0.025,
          ease: "none",
        },
        "+=0.15",
      );
    gsap.to(manager3ImgRef.current, {
      y: -14,
      duration: 2.7,
      yoyo: true,
      repeat: -1,
    ...
    gsap.to(manager3GlowRef.current, {
      scale: 1.15,
      opacity: 0.7,
      duration: 2.1,
      yoyo: true,
    ...
    const m4Tl = gsap.timeline({
      scrollTrigger: {
        trigger: manager4ContainerRef.current,
        start: "top 78%",
        once: true,
      },
    });
    m4Tl
      .from([manager4BoxRef1.current, manager4BoxRef2.current], {
        y: 60,
        opacity: 0,
        duration: 0.9,
        ease: "expo.out",
      ...
      .to(
        manager4TextRef1.current,
        {
          text: manager4Text1,
          duration: manager4Text1.length * 0.025,
          ease: "none",
        },
        "+=0.1",
      )
      .to(
        manager4TextRef2.current,
        {
          text: manager4Text2,
          duration: manager4Text2.length * 0.025,
          ease: "none",
        },
        "+=0.15",
      );
    gsap.to(manager4ImgRef.current, {
      y: -14,
      duration: 2.8,
      yoyo: true,
      repeat: -1,
    ...
    gsap.to(manager4GlowRef.current, {
      scale: 1.15,
      opacity: 0.7,
      duration: 2.4,
      yoyo: true,
    ...
    buildScene({
      trigger: manager5ContainerRef.current,
      box: manager5BoxRef.current,
      textEl: manager5TextRef.current,
      text: manager5Text,
      speed: 0.02,
      imgEl: manager5ImgRef.current,
      glowEl: manager5GlowRef.current,
    });
  ...
  const week01Assignments = [
    {
      ...
      title: "MINOR TASK",
      driveLink:
        "https://drive.google.com/file/d/1TODuPXOuXI7Pb8AoAUiIvZx8xvhPHgP1/view",
      isHighlight: false,
    },
    {
      id: 2,
      ...
      driveLink:
        "https://drive.google.com/file/d/18wk9LaSnKra5y5wqjHlFO-DQbOnxXhES/view",
      isHighlight: true,
    },
  ];
  ...
  return (
    <div
      className="flex min-h-screen bg-[#030507] w-full overflow-hidden"
      style={{
    ...
    >
      ...
      <aside
        className="hidden md:flex flex-col fixed left-0 top-0 h-screen w-60 z-50 pt-24"
        style={{
      ...
      >
        <span
          ...
          style={{
            background:
              "linear-gradient(180deg, #22d3ee, #4ade80, transparent)",
          }}
        />
        <div className="px-5 pb-5 mb-2 border-b border-white/[0.06]">
          <p className="text-white font-black tracking-[0.2em] uppercase text-xs mb-0.5">
            Workspace
          </p>
          <p className="text-gray-600 text-[9px] tracking-[0.3em] uppercase">
            Secure Terminal
          </p>
        </div>
          ...
          {navItems.map(({ id, label, Icon, color }) => {
            ...
            return (
              ...
              >
                <Icon
                  size={16}
                  style={{ color: active ? color.text : undefined }}
                  className={
                    !active ? "group-hover:text-white transition-colors" : ""
                  }
                />
      ...
      <main className="flex-1 md:ml-60 relative overflow-hidden">
        {activeTab === "discussions" && (
          <>
            <section className="min-h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden relative">
              <div className="w-full md:w-[42%] h-[42vh] md:h-screen flex flex-col items-center justify-end md:justify-center p-5 md:p-10 z-10 border-t md:border-t-0 border-white/[0.04]">
                <CharacterPanel
                  src="/manager.png"
                  alt="Manager"
                  glowRef={managerGlowRef}
                  imgRef={managerImgRef}
                  color="green"
                  align="end"
                />
              </div>
              <div className="w-full md:w-[58%] flex-1 md:min-h-screen flex items-start md:items-center justify-center md:justify-start p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0">
                <DialogueBox
                  ref={managerBoxRef}
                  color="green"
                  name="GREENEDGE_MANAGER // POD LEAD"
                  badge="Live Uplink"
                  pointer="left"
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 pt-6 border-t border-white/[0.06] mt-5 relative z-10">
                    <p className="text-gray-300 text-sm flex gap-1 tracking-wide animate-pulse">
                      ...
                      Click on the buttons to access docs:
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4">
                      <div className="relative overflow-hidden rounded-xl p-[1px] group">
                        ...
                        <div className="relative h-full w-full bg-[#020604] rounded-xl flex">
                          <DossierButton
                            href="https://drive.google.com/file/d/1Dw9bavgsCLcR1zaWcTFVtG-RrnDYThYR/view"
                            icon={BookOpen}
                            label="DOSSIER: Consulting"
                            color="green"
                            accent="#22d3ee"
                          />
                        </div>
                      ...
                      <div className="relative overflow-hidden rounded-xl p-[1px] group">
                        ...
                        <div className="relative h-full w-full bg-[#020604] rounded-xl flex">
                          <DossierButton
                            href="https://drive.google.com/file/d/1etZkky5X8zz1ow8xp4m4n0lOjWeFV_Xo/view"
                            icon={Leaf}
                            label="DOSSIER: Sustainability"
                            color="green"
                            accent="#4ade80"
                          />
                        </div>
            ...
            <section className="min-h-[100dvh] md:h-screen w-full flex flex-col-reverse md:flex-row overflow-hidden relative">
              <div className="w-full md:w-[58%] flex items-start md:items-center justify-center md:justify-end p-5 sm:p-10 md:pr-14 z-10 pb-14 md:pb-0">
                <DialogueBox
                  ref={ceoBoxRef}
                  color="orange"
                  name="ARYAN_MEHTA // CEO"
                  badge="Escalation Initiated"
                  pointer="right"
                  className="md:-translate-y-8"
                >
            ...
            <section
              ref={manager2ContainerRef}
              className="min-h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden relative"
            >
              <div className="w-full md:w-[42%] h-[42vh] md:h-screen flex flex-col items-center justify-end md:justify-center p-5 md:p-10 z-10 border-t md:border-t-0 border-white/[0.04]">
                <CharacterPanel
                  src="/managerpose2.png"
                  alt="Manager"
                  glowRef={manager2GlowRef}
                  imgRef={manager2ImgRef}
                  color="green"
                  align="end"
                />
              </div>
              <div className="w-full md:w-[58%] flex-1 md:min-h-screen flex flex-col items-start justify-center p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0 gap-5">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                    <DossierButton
                      href="https://drive.google.com/file/d/1UjjbVPDgw4O8G2o3ICFULH5IW-s9HoCs/view"
                      icon={BookOpen}
                      label="ASSET: Capital Markets"
                      color="green"
                      accent="#22d3ee"
                    />
                  </div>
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                    <DossierButton
                      href="https://drive.google.com/file/d/1vAGhCyuUEuXr49k83TC034DJGz2HpSoZ/view"
                      icon={FileText}
                      label="ASSET: Bridging Innovation"
                      color="green"
                      accent="#818cf8"
                    />
                  </div>
            ...
            <section
              ref={manager3ContainerRef}
              className="min-h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden relative"
            >
              <div className="w-full md:w-[42%] h-[42vh] md:h-screen flex flex-col items-center justify-end md:justify-center p-5 md:p-10 z-10 border-t md:border-t-0 border-white/[0.04]">
                <CharacterPanel
                  src="/managerpose3.png"
                  alt="Manager"
                  glowRef={manager3GlowRef}
                  imgRef={manager3ImgRef}
                  color="green"
                  align="end"
                />
              </div>
              <div className="w-full md:w-[58%] flex-1 md:min-h-screen flex flex-col items-start justify-center p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0 gap-5">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                    <DossierButton
                      href="https://drive.google.com/file/d/1lxNF2Y95GreJdtijwEvjaEniWv6Bk6-R/view"
                      icon={Globe}
                      label="DOSSIER: Sustainability Drivers"
                      color="green"
                      accent="#4ade80"
                    />
                  </div>
            ...
            <section
              ref={manager4ContainerRef}
              className="min-h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden relative"
            >
              <div className="w-full md:w-[42%] h-[42vh] md:h-screen flex flex-col items-center justify-end md:justify-center p-5 md:p-10 z-10 border-t md:border-t-0 border-white/[0.04]">
                <CharacterPanel
                  src="/managerpose4.png"
                  alt="Manager"
                  glowRef={manager4GlowRef}
                  imgRef={manager4ImgRef}
                  color="green"
                  align="end"
                />
              </div>
            ...
            >
              <div className="w-full md:w-[42%] h-[42vh] md:h-screen flex flex-col items-center justify-end md:justify-center p-5 md:p-10 z-10 border-t md:border-t-0 border-white/[0.04]">
                <CharacterPanel
                  src="/manager.png"
                  alt="Manager"
                  glowRef={manager5GlowRef}
                  imgRef={manager5ImgRef}
                  color="green"
                  align="end"
                />
              </div>
                ...
                >
                  ...
                  <div className="mt-8 border border-cyan-500/30 bg-cyan-950/10 rounded-2xl p-6 relative z-10 overflow-hidden shadow-[inset_0_0_40px_rgba(34,211,238,0.05)]">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 border-b border-cyan-500/20 pb-4">
                      <div>
                        ...
                        <p className="text-gray-400 text-[10px] font-mono tracking-widest">
                          Sprint Problem Map Architecture
                        </p>
                      </div>
                      <div className="flex items-center gap-2 bg-red-950/50 border border-red-500/30 px-3 py-1.5 rounded-lg">
                        ...
                        />
                        <span className="text-red-400 font-mono text-[10px] tracking-widest uppercase font-bold">
                          DEADLINE: SUN 23:59 IST
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-cyan-500/20">
                      <a
                        href="https://drive.google.com/file/d/1TODuPXOuXI7Pb8AoAUiIvZx8xvhPHgP1/view"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 group relative flex items-center justify-center gap-2 px-4 py-4 bg-cyan-600/20 hover:bg-cyan-500/30 border border-cyan-500/40 rounded-xl transition-all duration-300 active:scale-[0.98] overflow-hidden"
                      >
                        ...
                        <span className="text-cyan-100 font-mono text-xs font-bold tracking-widest uppercase relative z-10">
                          Minor Task Brief
                        </span>
                      </a>
                      <a
                        href="https://drive.google.com/file/d/18wk9LaSnKra5y5wqjHlFO-DQbOnxXhES/view"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 group relative flex items-center justify-center gap-2 px-4 py-4 bg-red-600/20 hover:bg-red-500/30 border border-red-500/40 rounded-xl transition-all duration-300 active:scale-[0.98] overflow-hidden"
                      >
              ...
              <div className="mb-12 border-b border-white/10 pb-6 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                <div>
                  ...
                  <p className="text-zinc-500 mt-3 text-sm md:text-base tracking-wide max-w-2xl">
                    Track your operational deployment and structured
                    deliverables.
                  </p>
                </div>
              ...
              {activeWeek === "week01" ? (
                  ...
                  {week01Assignments.map((task) => (
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mb-6 relative z-10">
                        <span
                          className={`text-[10px] font-black tracking-widest uppercase px-3 py-1.5 rounded-full border backdrop-blur-md shadow-sm
                         ${
                           task.isHighlight
                        ...
                        <div
                          className={`${task.isHighlight ? "text-red-400" : "text-zinc-600 group-hover:text-cyan-400"} transition-colors bg-white/5 p-2 rounded-full border border-white/5`}
                        >
                ...
                <div className="flex flex-col items-center justify-center w-full py-32 border border-dashed border-white/10 rounded-[40px] bg-zinc-900/20 max-w-4xl mx-auto md:mx-0 backdrop-blur-xl shadow-2xl">
                  ...
                  <p className="text-sm text-zinc-500 max-w-md text-center tracking-wide leading-relaxed">
                    Week 02 operational assignments are currently locked. The
                    system will deploy the assets when clearance is granted.
                  </p>
