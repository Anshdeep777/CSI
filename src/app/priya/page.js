    ...
    >
      ...
      >
        ...
        >
          <span
            ...
            style={{ background: c.pulse, boxShadow: `0 0 6px ${c.pulse}` }}
          />
          {badge}
        </span>
      </div>
      <div className="p-5 md:p-8">
        <p className="text-sm md:text-lg text-gray-200 leading-relaxed min-h-[110px]">
          {typed}
          <span
            className="inline-block w-[3px] h-[1.1em] ml-0.5 align-middle rounded-[1px] animate-pulse"
...
function DualAnimatedDialogue({
  ...
  return (
    <div
      ref={containerRef}
      className="flex flex-col items-start justify-center gap-5 w-full md:w-[58%] p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0"
    >
      <div
        className="relative w-full max-w-2xl"
        style={{
          ...fadeInStyle(inView, 0),
          background: "rgba(2,4,8,0.85)",
...
function FloatImage({ src, alt, color }) {
  ...
  return (
    <div
      className="relative group shrink-0 md:-translate-y-10"
    ...
    >
      ...
      <img
        ...
        style={{
          filter: `drop-shadow(0 0 40px ${c.glow})`,
          maxHeight: "420px",
        }}
      />
    </div>
...
function ChapterDivider({ icon: Icon, label, title, accent, highlight }) {
  ...
  return (
    <div
      ref={ref}
      className="w-full py-20 flex flex-col items-center justify-center relative z-10 chapter-divider"
      style={fadeInStyle(inView)}
    >
      <div
  ...
  return (
    <section className="min-h-[100dvh] w-full flex flex-col items-center justify-center relative z-10 px-6 py-20">
      <div className="max-w-3xl text-center space-y-8">
        <div
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-[10px] tracking-[0.3em] uppercase font-bold"
          style={{
        ...
        <h1
          className="text-4xl md:text-6xl font-black tracking-[0.08em] uppercase leading-none"
        ...
        <div
          className="max-w-2xl mx-auto p-6 rounded-2xl text-left"
          style={{
            background: "rgba(2,4,8,0.85)",
            border: "1px solid rgba(34,211,238,0.2)",
              ...
              <DualAnimatedDialogue
                ...
                children1={
                  <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                    <DossierButton
                      href="https://drive.google.com/file/d/1RLaMSTRbGMmWLs9SZMfB61AyynrOUxBV/view?usp=sharing"
                      icon={BookOpen}
                ...
                children2={
                  <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                    <DossierButton
                      href="https://drive.google.com/file/d/16wxLS3rMITJLarjm-gzM9kEJ85LQPj0D/view?usp=sharing"
                      icon={FileText}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-cyan-500/20">
                      ...
                      >
                        ...
                        <span className="text-red-100 font-mono text-xs font-bold tracking-widest uppercase relative z-10">
                         Read Major Deliverable 
                        </span>
                      </a>
                    </div>
                  </div>
                  <div className="flex flex-col gap-2 p-2 mt-2">
                    <p className="text-green-400 mt-4">Submission is live!</p>
                    <a
                      className="w-full bg-gradient-to-br from-cyan-500/20 via-zinc-800/40 to-black/60 backdrop-blur-xl border-t border-l border-cyan-400/30 border-b border-r border-black/80 shadow-[0_0_20px_rgba(6,182,212,0.15),12px_12px_24px_rgba(0,0,0,0.7),inset_1px_1px_2px_rgba(6,182,212,0.2)] transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(6,182,212,0.4),16px_16px_32px_rgba(0,0,0,0.9),inset_2px_2px_4px_rgba(6,182,212,0.4)] hover:from-cyan-500/30 rounded-xl text-cyan-200 hover:text-cyan-100 font-bold px-6 py-3 tracking-widest uppercase text-sm group flex items-center justify-center gap-2"
                      href="https://forms.gle/Zpx7AG7UipntJK9U9"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <UploadIcon />
                      <span className="drop-shadow-[0_0_8px_rgba(34,211,238,0.6)]">
                        Click to Submit Minor task
                      </span>
                    </a>
                    <a className="w-full bg-gradient-to-br from-red-600/20 via-zinc-800/40 to-black/60 backdrop-blur-xl border-t border-l border-red-500/30 border-b border-r border-black/80 shadow-[0_0_20px_rgba(248,113,113,0.15),12px_12px_24px_rgba(0,0,0,0.7),inset_1px_1px_2px_rgba(248,113,113,0.2)] transition-all duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(248,113,113,0.4),16px_16px_32px_rgba(0,0,0,0.9),inset_2px_2px_4px_rgba(248,113,113,0.4)] hover:from-red-600/30 rounded-xl text-red-200 hover:text-red-100 font-bold px-6 py-3 tracking-widest uppercase text-sm group flex items-center justify-center gap-2"
                     href="https://forms.gle/VTPamWWCWgBxTvJo8"
                      target="_blank"
                      rel="noopener noreferrer">
                      <UploadIcon />
                      <span className="drop-shadow-[0_0_8px_rgba(248,113,113,0.6)]">
                        Click to Submit Major task
                      </span>
                    </a>
                  </div>
              ...
              <div className="mb-12 border-b border-white/10 pb-6 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
                ...
                <div className="flex gap-2 bg-zinc-900/60 p-1.5 rounded-full border border-white/10 backdrop-blur-xl shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
                  <button
                    ...
                    className={`px-6 py-2 rounded-full font-bold text-xs sm:text-sm tracking-wider uppercase transition-all duration-300 ${activeWeek === "week01" ? "bg-zinc-200 text-black shadow-[0_0_15px_rgba(255,255,255,0.2)]" : "text-zinc-500 hover:text-zinc-300"}`}
                  >
                    Week 01
                  </button>
                  <button
                    onClick={() => setActiveWeek("week02")}
                    className={`px-6 py-2 rounded-full font-bold text-xs sm:text-sm tracking-wider uppercase transition-all duration-300 ${activeWeek === "week02" ? "bg-zinc-200 text-black shadow-[0_0_15px_rgba(255,255,255,0.2)]" : "text-zinc-500 hover:text-zinc-300"}`}
                  >
                    Week 02
                  </button>
                </div>
              ...
              {activeWeek === "week01" ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto md:mx-0">
                  {week01Assignments.map((task) => (
                    ...
                    >
                      <div
                        className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${task.isHighlight ? "bg-gradient-to-br from-red-500/10 to-transparent" : "bg-gradient-to-br from-cyan-500/10 to-transparent"}`}
                      />
                      <div className="flex items-center justify-between mb-6 relative z-10">
                        <span
                          className={`text-[10px] font-black tracking-widest uppercase px-3 py-1.5 rounded-full border backdrop-blur-md shadow-sm ${task.isHighlight ? "text-red-400 bg-red-950/50 border-red-500/30 animate-pulse" : "text-cyan-400 bg-cyan-950/40 border-cyan-500/30"}`}
                        >
                          {task.type}
                        </span>
                        <div
