...
// Reusable Background Scan Lines
const ScanLines = () => (
  <div
...
// Reusable Terminal Dialogue Box
...
// Reusable Dossier Button
const DossierButton = ({ icon: Icon, label, color, accent }) => (
  <button
    className="group relative flex-1 flex items-center gap-2.5 px-4 py-3 rounded-xl text-xs tracking-widest uppercase overflow-hidden transition-all duration-300 active:scale-[0.97]"
...
// Reusable Character Display Panel
...
// Reusable Chapter Title Divider
...
// Reusable Animated Blinking Cursor
const Cursor = ({ color }) => (
...
const Page = () => {
  ...
  // Manager 4 - Split into two parts to match the flow
  ...
  // Adjusted Refs for Manager 4 (Two Boxes)
  ...
  // Typewriter effect for initial email alert
  useEffect(() => {
    let index = 0;
  ...
  // Handle all GSAP scroll-triggered animations
  useGSAP(() => {
    ...
    // Multi-box sequences for Manager 2
    ...
    // Multi-box sequences for Manager 3
    ...
    // Multi-box sequences for Manager 4 (Systems Thinking + Feedback Loops)
    ...
    // Final Boss Sequence for Manager 5
  ...
  return (
    <div className="flex min-h-screen bg-[#030507] w-full overflow-hidden" style={{ fontFamily: "'Geist Mono', 'JetBrains Mono', 'Fira Code', monospace" }}>
      ...
      <main className="flex-1 md:ml-60 relative overflow-hidden">
              ...
              <div className="flex flex-col gap-4 pt-6 border-t border-white/[0.06] mt-5 relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="relative overflow-hidden rounded-xl p-[1px] group">
                    ...
                    <div className="relative h-full w-full bg-[#020604] rounded-xl">
                      <DossierButton icon={BookOpen} label="DOSSIER: Consulting" color="green" accent="#22d3ee" />
                    </div>
                  </div>
                  <div className="relative overflow-hidden rounded-xl p-[1px] group">
                    ...
                    <div className="relative h-full w-full bg-[#020604] rounded-xl">
                      <DossierButton icon={Leaf} label="DOSSIER: Sustainability" color="green" accent="#4ade80" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Narrative Flow - Manager Damage Control */}
          ...
          <div className="w-full md:w-[58%] flex-1 md:min-h-screen flex flex-col items-start justify-center p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0 gap-5">
            <DialogueBox ref={manager2BoxRef1} color="green" name="GREENEDGE_MANAGER // POD LEAD" badge="Live Uplink" pointer="left">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                <DossierButton icon={BookOpen} label="ASSET: Capital Markets" color="green" accent="#22d3ee" />
              </div>
            </DialogueBox>
            <DialogueBox ref={manager2BoxRef2} color="green" name="GREENEDGE_MANAGER // POD LEAD" badge="Live Uplink">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                <DossierButton icon={FileText} label="ASSET: Bridging Innovation" color="green" accent="#818cf8" />
              </div>
            </DialogueBox>
          </div>
        </section>
        ...
        {/* Narrative Flow - Manager 3 (Macro) */}
        <section ref={manager3ContainerRef} className="min-h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden relative">
          ...
          <div className="w-full md:w-[58%] flex-1 md:min-h-screen flex flex-col items-start justify-center p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0 gap-5">
            ...
            <DialogueBox ref={manager3BoxRef2} color="green" name="GREENEDGE_MANAGER // POD LEAD" badge="Live Uplink">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-5 border-t border-white/[0.06] mt-4">
                <DossierButton icon={Globe} label="DOSSIER: Sustainability Drivers" color="green" accent="#4ade80" />
              </div>
            </DialogueBox>
          </div>
        </section>
        ...
        {/* Narrative Flow - Priya Urgent Ping */}
        <section className="min-h-[100dvh] md:h-screen w-full flex flex-col-reverse md:flex-row overflow-hidden relative">
          <div className="w-full md:w-[58%] flex items-start md:items-center justify-center md:justify-end p-5 sm:p-10 md:pr-14 z-10 pb-14 md:pb-0">
        ...
        {/* Narrative Flow - Manager 4 (Systems Thinking + Feedback Loops) */}
        <section ref={manager4ContainerRef} className="min-h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden relative">
          ...
          <div className="w-full md:w-[58%] flex-1 md:min-h-screen flex flex-col items-start justify-center p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0 gap-5">
              ...
              <div className="flex flex-col gap-4 pt-6 border-t border-white/[0.06] mt-5 relative z-10">
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="relative overflow-hidden rounded-xl p-[1px] group">
                    <div className="absolute inset-[-500%] animate-[spin_2.5s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,transparent_0%,transparent_50%,#4ade80_100%)] opacity-80 group-hover:opacity-100 transition-opacity duration-300" />
                    <div className="relative h-full w-full bg-[#020604] rounded-xl">
                      <DossierButton icon={BookOpen} label="ASSET: Systems Thinking" color="green" accent="#4ade80" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Box 2: Feedback Loops and Trade-Offs */}
              ...
              <div className="flex flex-col gap-4 pt-6 border-t border-white/[0.06] mt-5 relative z-10">
                <div className="flex flex-col sm:flex-row gap-4">
                  <div className="relative overflow-hidden rounded-xl p-[1px] group">
                    ...
                    <div className="relative h-full w-full bg-[#020604] rounded-xl">
                      <DossierButton icon={Activity} label="ASSET: Feedback & Trade-Offs" color="green" accent="#c084fc" />
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* Narrative Flow - Manager 5 (Final Boss Directive) */}
        <section ref={manager5ContainerRef} className="min-h-[100dvh] w-full flex flex-col md:flex-row overflow-hidden relative">
          <div className="w-full md:w-[42%] h-[42vh] md:h-screen flex flex-col items-center justify-end md:justify-center p-5 md:p-10 z-10 border-t md:border-t-0 border-white/[0.04]">
            <CharacterPanel src="/managerboss.png" alt="Manager" glowRef={manager5GlowRef} imgRef={manager5ImgRef} color="green" align="end" />
          </div>
          <div className="w-full md:w-[58%] flex-1 md:min-h-screen flex flex-col items-start justify-center p-5 sm:p-10 md:pl-14 z-10 pb-14 md:pb-0 gap-5">
            <DialogueBox ref={manager5BoxRef} color="green" name="GREENEDGE_MANAGER // POD LEAD" badge="Mission Directive" pointer="left">
              ...
              <div className="mt-8 border border-cyan-500/30 bg-cyan-950/10 rounded-2xl p-6 relative z-10 overflow-hidden shadow-[inset_0_0_40px_rgba(34,211,238,0.05)]">
                ...
                <button className="w-full group relative flex items-center justify-center gap-2 px-4 py-4 bg-cyan-600/20 hover:bg-cyan-500/30 border border-cyan-500/40 rounded-xl transition-all duration-300 active:scale-[0.98] overflow-hidden">
                  ...
                  <UploadCloud size={18} className="text-cyan-300 relative z-10 group-hover:-translate-y-1 transition-transform" />
                  <span className="text-cyan-100 font-mono text-xs font-bold tracking-widest uppercase relative z-10">Upload Diagnostic Memo</span>
                </button>
              </div>
